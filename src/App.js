	...
	update(state) {
		...
		if (state.G._mapGenerated) { // Handle cell updates only if a map is generated
			...
			cells.forEach(cell => {
				...
				if (cellValue == "O" || cellValue == "I") { // If cell is an empty tile, actually draw a blank char
				...
				else if (cellValue == "WN" || cellValue == "WS") { // If cell is an empty tile, actually draw a blank char
					cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/wall.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
				}
					...
					cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/doorS.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
				}
				else if (cellValue == "DS") { // If cell is an empty tile, actually draw a blank char
					cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/doorN.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
				}
				else if (cellValue == "DE") { // If cell is an empty tile, actually draw a blank char
					cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/doorW.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
				}
				else if (cellValue == "DW") { // If cell is an empty tile, actually draw a blank char
					cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/doorE.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
				}
				...
				for (let ii = 0; ii < state.G.playerLocations.length; ii++) { // Check if this cell contains a player. Append the player num if so
					if (cellCoords[0] == state.G.playerLocations[0][0] && cellCoords[1] == state.G.playerLocations[0][1]) {
						...
						cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/blueplayer.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
						containsPlayer = true;
					}
					else if (cellCoords[0] == state.G.playerLocations[1][0] && cellCoords[1] == state.G.playerLocations[1][1]) {
						cell.textContent += ii; // Player ID/char is just it's num/index
						cell.innerHTML = "<img src='https://nrmaultsaid.jalbum.net/images/slides/redplayer.png' style='width: 50px; height: 50px; object-fit; fill;'/>"; // This is temporary !!!
						containsPlayer = true;
					}
				}
